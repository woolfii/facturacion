...
<script>
    $(document).ready(function(){
        $('#CalendarioWeb').fullCalendar({
            ...
            events:'http://localhost/sect/eventos.php',
    ...
    //recolecto datos del modal para con EnviarInformacion ir a eventos.php y modifificar la BD sectdb.
      ...
      function EnviarInformacion(accion, objEvento,modal){
          ...
          $.ajax({
              ...
              error:function(){
                  alert("Ocurrio un error, verifica que has llenado correctamente la informacion! o checa disponibilidad del material en inventario.");
              }
          });
      }
